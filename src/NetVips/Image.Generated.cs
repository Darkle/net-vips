...
namespace NetVips
{
    ...
    public partial class Image
    {
        ...
        /// <example>
        /// <code language="lang-csharp">
        /// var output = in.FindTrim(threshold: double, background: double[], vector: bool);
        /// </code>
        /// </example>
        /// <param name="threshold">Object threshold.</param>
        /// <param name="background">Color for background pixels.</param>
        /// <param name="vector">Trim vector images.</param>
        /// <returns>An array of objects.</returns>
        public object[] FindTrim(double? threshold = null, double[] background = null, bool? vector = null)
        {
            var options = new VOption();

            options.AddIfPresent(nameof(threshold), threshold);
            options.AddIfPresent(nameof(background), background);
            options.AddIfPresent(nameof(vector), vector);
